...
\begin{document}
    ...
    \hline
    Sphere & Small & 2 & 250 & 0.0045 & 0.3983 & 0.011 \\
    Sphere & Medium & 10 & 2000 & 0.0089 & 0.4432 & 0.020 \\
    Sphere & Large & 50 & 10000 & 0.0417 & 0.6185 & 0.067 \\
    Rastrigin & Small & 2 & 250 & 0.0048 & 0.3975 & 0.012 \\
    Rastrigin & Medium & 10 & 2000 & 0.0099 & 0.4409 & 0.022 \\
    Rastrigin & Large & 50 & 10000 & 0.0611 & 0.7017 & 0.087 \\
    \hline
    \end{tabular}
    ...
    The latest measurements do not show a CUDA crossover in this implementation. OpenMP remains faster on all tested sizes, although the relative gap becomes smaller as the workload increases. This indicates that the GPU path still carries enough orchestration overhead to outweigh its parallelism benefits for these benchmark sizes.

    On the largest Sphere case, CUDA is still about 14.8x slower than OpenMP. On the largest Rastrigin case, CUDA is about 11.5x slower. The more expensive Rastrigin function does not reverse the trend, but it does narrow the gap slightly because it offers more arithmetic work per individual.

    These measurements are still useful for the implementation goal of the project: they show that the GPU backend is functionally correct and scalable in problem size, but it still needs further optimization before it can outperform the OpenMP version on these benchmarks. The remaining bottlenecks are likely in memory movement, synchronization, and kernel efficiency rather than in the genetic operators themselves.
